...
<div class="container">
	...
	{/if}
	<div class="page-header"><h2 class="shopping-cart-header"><a href="{$BASE_URL}pages/users/my-account/">My account</a> / Your reviews</h2></div>
	...
	<div class="text-center">
		<ul class="pagination">
			...
			<li><a href="{$BASE_URL}pages/users/reviews/?page=1">&laquo; First</a></li>
			<li><a href="{$BASE_URL}pages/users/reviews/?page={$previousPage}">&lt;</a></li>
			{else}
			<li class="disabled"><a href="{$BASE_URL}pages/users/reviews/?page=1">&laquo; First</a></li>
			<li class="disabled"><a href="{$BASE_URL}pages/users/reviews/?page={$previousPage}">&lt;</a></li>
			{/if}
			{for $i=$fromPage to $toPage}
			{if $i eq $currentPage}
			<li class="active"><a href="#">{$i}</a></li>
			{else}
			<li><a href="{$BASE_URL}pages/users/reviews/?page={$i}">{$i}</a></li>
			{/if}
			{/for}
			{if $currentPage neq $lastPage}
			<li><a href="{$BASE_URL}pages/users/reviews/?page={$nextPage}">&gt;</a></li>
			<li><a href="{$BASE_URL}pages/users/reviews/?page={$lastPage}">Last &raquo;</a></li>
			{else}
			<li class="disabled"><a href="{$BASE_URL}pages/users/reviews/?page={$nextPage}">&gt;</a></li>
			<li class="disabled"><a href="{$BASE_URL}pages/users/reviews/?page={$lastPage}">Last &raquo;</a></li>
			{/if}
		</ul>
	</div>
	{/if}
